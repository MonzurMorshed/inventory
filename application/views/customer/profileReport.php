<?php 
    ...
    $rdata .= '
        <div style="line-height:0.8;padding:10%;font-size:1em;font-family:times;">
    ...
    $this->mytcpdf->WriteHTMLCell(0,0,15,50,$rdata,0,1,0, true,'L',true);
    
    $name = '';
    $name .= '<div style="line-height:0.8;padding:10%;font-size:1em;font-family:times;"><p>Customer Name : '.$_GET['c_n'].'</p>
    <p>Customer Phone : '.$_GET['c_r'].'</p>
    <p>Customer Email : '.$_GET['c_em'].'</p></div>';
    
    $this->mytcpdf->WriteHTMLCell(0,0,15,50,$name,0,1,0, true,'R',true);
    ...
    $html .= '<br><br><br>
            <table id="info_table" class="table table-striped" id="info_table" style="">
                ...
                <tr style="line-height:2;background-color:#470011;color:#fff;padding:15%;font-size:1em;font-family:times;">
                    <th style="line-height:2;padding:15%;font-size:1em;font-family:times;">Selling Date </th>
                    <th style="line-height:2;padding:15%;font-size:1em;font-family:times;">Sales ID</th>
                    ...
                    <th style="line-height:2;padding:15%;font-size:1em;font-family:times;">Net Price </th>
    ...
    foreach($user_profile as $p){            
            $html .= '<tr style="line-height:2;padding:15%;font-size:1em;font-family:times;">
                        <td style="line-height:2;padding:15%;font-size:1em;font-family:times;">'.$p->selling_date.'</td>
                        <td style="line-height:2;padding:15%;font-size:1em;font-family:times;">'.$p->sales_id.'</td>
                        ...
                        <td style="line-height:2;padding:15%;font-size:1em;font-family:times;">'.$p->price.'</td>
                        <td style="line-height:2;padding:15%;font-size:1em;font-family:times;">'.$p->price * $p->quantity.'</td>
                     </tr>';
            $val += ($p->quantity*$p->price);
    }
    
    $html .=  '</tbody>
         </table><br><br><br><hr style="height:1px;background-color:#470011;">';
            
    $this->mytcpdf->WriteHTMLCell(0, 0,'','',$html,0,1,0, true,'C',true);
    
    $total = '';
    $total .= '<br><span style="text-align:right;font-weight:600">Total Amount    :   </span>'.$val;
    
    $this->mytcpdf->WriteHTMLCell(0, 0,'','',$total,0,1,0, true,'C',true);
